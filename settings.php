...
<body>
    ...
    <div class="body no-margin">
        <div class="row justify-content-center mt-4">
            <div class="col col-md-8" id="settings_pass_div">
                <p class="text-left mt-2 fw-bold">Personal Information</p>
                ...
                <p class="fw-bold mt-3">Bank Information</p>
                <div class="row justify-content-between gap no-margin">
                    <div class="col mt-1 my-3">
                ...
                <div>
                    <p class="changepass mx-auto"><a href="" id="change_pass_a">Change Password</a></p>
                    <button class="settings text-center mx-auto">Save Changes</button>
                </div>
            </div>
            <div class="col col-md-6 d-none" id="change_pass_div">
