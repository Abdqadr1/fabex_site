            ...
            <div class="col col-md-5 col-lg-3" id="settings_pass_div">
                ...
                <div class="row justify-content-center" id="change_row">
                    ...
                    <div class="col-10 mt-1 my-3">
                        ...
                        <input type="text" class="form-control rad8" id="con-password" placeholder="At least 8 characters">
                    </div>
                </div>

                <div class="row justify-content-center">
                    <button class="col-10 settings text-center mx-auto">Create password</button>
                </div>
            </div>
        </div>
    </div>
