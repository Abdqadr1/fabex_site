    ...
    <div class="body no-margin">
        <div class="row justify-content-center mt-4">
            <div class="col-10 col-md-9 col-lg-7" id="settings_pass_div">
                ...
                <form action="post" action="php/register.php" id="registerForm">
                    <div class="row justify-content-center justify-content-md-between gap no-margin mt-1 my-3">
                        <div class="col-11 col-md-5 mx-auto">
                            ...
                            <input type="text" class="form-control rad8" id="firstname" placeholder="Enter first name" required>
                        </div>
                        <div class="col-11 col-md-5 mx-auto">
                            <label for="lastname" class="form-label settings">Last name</label>
                            <input type="text" class="form-control rad8" id="lastname" placeholder="Enter last name" required>
                        </div>
                    </div>
                    <div class="row justify-content-center justify-content-md-between gap no-margin mt-1 my-3">
                        <div class="col-11 col-md-5 mx-auto">
                            <label for="phonenumber" class="form-label settings">Phone number</label>
                            <input type="text" class="form-control rad8" id="phonenumber" placeholder="Enter phone number" required>
                        </div>
                        <div class="col-11 col-md-5 mx-auto">
                            <label for="email" class="form-label settings">Email</label>
                            <input type="email" class="form-control rad8" id="email" placeholder="Enter Email address" required>
                        </div>
                    </div>
                    <div class="row justify-content-center justify-content-md-between gap no-margin mt-1 my-3">
                        <div class="col-11 col-md-5 mx-auto">
                            <label for="password" class="form-label settings">Password</label>
                            <input type="text" class="form-control rad8" id="password" placeholder="At least 8 characters" required>
                        </div>
                        <div class="col-11 col-md-5 mx-auto">
                            <label for="con-password" class="form-label settings">Confirm password</label>
                            <input type="email" class="form-control rad8" id="con-password" placeholder="At least 8 characters" required>
                        </div>
                    </div>
                    <div class="form-check no-margin">
                        <input class="form-check-input mx-3" type="checkbox" id="flexCheckChecked" required>
                        <label class="form-check-label" for="flexCheckChecked" style="max-width: 80%;">
                            I agree to the terms, conditions and privacy policy
                        </label>
                    </div>
                    <div class="row justify-content-center">
                        <button type="submit" class="col-5 settings text-center mx-auto">Register</button>
                    </div>
                </form>
